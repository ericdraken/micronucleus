...
/* Override the usbconfig.h power */
...
#define ENTRYMODE ENTRY_JUMPER_APA106
...
#elif ENTRYMODE==ENTRY_JUMPER_APA106
  // Enable pull up on jumper pin and delay to stabilize input    
 ...
 *          CLEAR_APA106      Turn off the APA106 by setting the PWM to black (off)
 *
...
#define LED_PIN     PB1     /* APA106 DIN is on this pin */
